        ...
        <Element name="pricing">
            <div className='container'>
                ...
                mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
                    ...
                    max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm'>Flexible pricing for every business</h3>
                    ...
                    backdrop-blur-[6px] max-md:w-[310px]'>
                        ...
                        <button
                        className={clsx("pricing-head_btn", !monthly && "text-p4")} 
                        onClick={() => setMonthly(false)}>Annually</button>
                    ...
                    <div className='pricing-bg'>
                        ...
                        <img src="/images/bg-outlines-fill.png" alt="outline" width={960} height={380} className='absolute inset-0
                        opacity-5 mic-blend-soft-light' />
                    </div>             
                </div>
                ...
                <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6'>
                    {plans.map((plan, index) => (
                        ...
                        relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]'>
                            ...
                            <div className={clsx("absolute left-0 right-0 z-2 flex items-center justify-center", index === 1 ? "-top-6"
                                : "-top-6 xl:-top-11",
                            )}>
                            ...
                            <ul className='mx-auto spaxe-y-4 xl:px-7'>
